...
className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-12 lg:gap-8"
    ...
    />
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-sm">
              Engineering digital experiences for a smarter future.
            </p>
            <div className="flex gap-3 mt-6">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-10 h-10 rounded-lg bg-gray-200 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-brand-500 hover:text-white transition-all duration-300"
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      to={link.path}
                      className="text-sm text-gray-600 dark:text-gray-400 hover:text-brand-500 transition-colors relative group"
                    >
                      {link.name}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
              <li>info@metamindspvtltd.com</li>
              <li>+91 9494890262</li>
